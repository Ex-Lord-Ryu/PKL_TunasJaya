                                ...
                                <tbody>
                                    @foreach ($master_warna as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('master_warna.edit', $item->id_warna) }}"
                                                    class="btn btn-primary btn-sm action-btn mr-1 edit-btn">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <form action="{{ route('master_warna.delete', $item->id_warna) }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-btn', function(e) {
                ...
                Swal.fire({
                    title: 'Edit Warna',
                    text: "Apakah Anda yakin ingin mengedit data warna ini?",
                    icon: 'question',
                    showCancelButton: true,
